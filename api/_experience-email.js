...
function experienceEmail(email) {
...
<tr><td style="padding:0 32px 30px;"><p style="font-size:16px;line-height:1.7;margin:0 0 22px;">Just reply to this email. A quick sentence is plenty, and our team is here to help.</p>
<table role="presentation" cellpadding="0" cellspacing="0"><tr><td bgcolor="#bd2e18" style="background:#bd2e18;"><a href="mailto:info@revivefw.com?subject=My%20first%20visit%20to%20REVIVE" style="display:inline-block;padding:18px 26px;color:#ffffff;font-size:14px;font-weight:bold;text-decoration:none;letter-spacing:1px;">TELL US ABOUT YOUR VISIT &rarr;</a></td></tr></table>
