...
function experienceEmail(email, feedbackUrl) {
  ...
  return {
    ...
    html: header.replace('<title>Your REVIVE Pass</title>', '<title>How was your first visit?</title>')
      .replace('Claiming does not start or reset your seven days. Show your confirmation at check in.', 'Tell us what you tried and how it felt. Your personal feedback form is ready.') + `
