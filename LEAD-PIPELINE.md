...
The admin shows a proposed schedule relative to activation: one first visit email two hours after redemption, Day 5 PT offer at 9 AM Eastern, Day 7 final day reminder at 9 AM Eastern, Day 10 three more free days, Day 13 PT joining bonus reopened until closing that day. The separate Day 3 feedback email was removed at the owner's request and stays removed. All five followups are live queued jobs.

Approved joining offer (reopened for Day 13 only, until closing that day): complete membership enrollment before Day 7 closing to receive one free personal training session with Kings Nutrition on Essential or Plus, or two sessions total on Elite. Joining early qualifies for the same bonus. The Elite total is two, not three, including any existing Elite PT benefit. No additional written plan, coaching check in, price discount, or invented dollar value is promised. PT sessions can occur afterward; the front desk coordinates fulfillment. Booking a visit alone does not qualify. Tier selection and PT redemption tracking still need implementation before an automated fulfillment workflow is enabled.
...
The Resend sequence is live for every activated pass with unsubscribe handling in place; still settle holiday closing exceptions and PT fulfillment. The Day 10 extension has no claim deadline yet. Day 13 reopens the same PT bonus with the same enrollment rules, ending at closing on Day 13. The proposal's classes wording conflicts with the site's current verified facts and must not be used without confirmation. Marking a confirmation as sent records an external action; it does not send email.
