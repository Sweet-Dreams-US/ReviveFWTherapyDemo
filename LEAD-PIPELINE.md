...
The admin shows a proposed schedule relative to activation: one first visit email two hours after redemption, Day 5 PT offer at 9 AM Eastern, Day 7 final day reminder at 9 AM Eastern, Day 10 three more free days, Day 13 six month preferred rate. The separate Day 3 feedback email was removed at the owner's request and stays removed. All five followups are live queued jobs; Day 13 holds until the six month rates are saved in admin.
...
The Resend sequence is live for every activated pass with unsubscribe handling in place; still settle holiday closing exceptions and PT fulfillment. The Day 10 extension has no claim deadline and the Day 13 offer has no end date or written term details yet; the email directs guests to ask the front desk for full terms. The proposal's classes wording conflicts with the site's current verified facts and must not be used without confirmation. Marking a confirmation as sent records an external action; it does not send email.
