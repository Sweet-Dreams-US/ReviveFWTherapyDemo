---
title: "How a decision in your head becomes a rep on the bar"
slug: "how-a-decision-becomes-a-rep-synapses"
meta_description: "Between deciding to stand up out of a squat and actually doing it, a signal crosses gaps it cannot jump. Here is how synapses work and where fatigue really starts."
primary_keyword: "how nerves talk to muscles"
secondary_keywords: ["neuromuscular junction", "neurotransmitters explained", "acetylcholine and muscle", "synapse function", "why practice improves movement"]
category: "Health Basics"
course: "BIO 102 — Human Physiology I: Cell, Muscle & Cardiorespiratory Systems"
unit: "Unit 2 — Neural and Neuromuscular Physiology"
chapter: "Chapter 2.2 — Synaptic Transmission"
...
Practice the technical thing while your nervous system is fresh, not at the end when you are cooked. Put a new movement — a clean, a Turkish get-up, a first attempt at a loaded carry — in the first fifteen minutes of a session, keep the sets short, and stop while every rep still looks the same. Skill is built by repetitions your brain can actually attend to. That is also why we keep coaches on the floor: someone is watching your reps rather than counting heads. Read more about how the floor is set up at [Why Revive](https://revivefw.com/why-revive).

## What to read next

Next: why the tenth rep of a set feels nothing like the first, even though the weight on the bar never changed. The answer is the order your body hires muscle in, and you cannot skip the line.
